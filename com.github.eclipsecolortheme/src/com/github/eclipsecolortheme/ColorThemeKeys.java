...
public class ColorThemeKeys {
	...
	public static final String SELECTED_TAB_INITIAL_BACKGROUND = "selectedTabInitialBackground";
	public static final String SELECTED_TAB_ACTIVE_INITIAL_BACKGROUND = "selectedTabActiveInitialBackground";
	...
	static {
		...
		KEYS_BACKGROUND_RELATED.add(SELECTED_TAB_INITIAL_BACKGROUND);
		KEYS_BACKGROUND_RELATED.add(SELECTED_TAB_ACTIVE_INITIAL_BACKGROUND);
	...
	static{
		...
		ALL_KEYS.add(SELECTED_TAB_INITIAL_BACKGROUND);
		ALL_KEYS.add(SELECTED_TAB_ACTIVE_INITIAL_BACKGROUND);
	...
	static {
		...
		KEYS_WITHOUT_STYLE.add(SELECTED_TAB_INITIAL_BACKGROUND);
		KEYS_WITHOUT_STYLE.add(SELECTED_TAB_ACTIVE_INITIAL_BACKGROUND);
